            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mt-3">
                    <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="../../index.html" value="LOGOWANIE">
                  </div>
                  <div class="text-center mt-4 font-weight-light"> Nie masz konta? <a href="login.html" class="text-primary">Zarejestruj się</a>
                  </div>
                </form>
              </div>
            </div>
